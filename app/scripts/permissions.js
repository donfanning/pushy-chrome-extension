...
app.Permissions = (function() {
  ...
  return {
     ...
     */
    notSet: function() {
      return Chrome.Storage.get('permissions') === NOT_SET;
    },
     ...
     */
    isAllowed: function() {
      return Chrome.Storage.get('permissions') === ALLOWED;
    },
    ...
    request: function() {
      ...
      const ifGranted = function(isTrue) {
        if (isTrue) {
          Chrome.Storage.set('permissions', app.Permissions.ALLOWED);
      ...
      const ifContains = function(isTrue) {
        if (isTrue) {
          ...
          return chromep.permissions.remove({
            ...
            if (removed) {
              Chrome.Storage.set('permissions',
