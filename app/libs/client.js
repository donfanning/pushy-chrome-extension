...
(function() {/*
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  var g = window, h = document, m = g.location, n = function() {},
      q = /\[native code\]/, u = function(a, b, c) {return a[b] = a[b] || c},
      aa = function(a) {
        a = a.sort();
  ...
  var G = function(a, b, c) {
    ...
    b && 0 < b.length &&
    (b = J(b), c && 0 < c.length && (b += "___" + J(c)), 28 < b.length &&
    (b = b.substr(0, 28) + (b.length - 28)), c = b, b = u(ca, "_p", w()), u(b,
        c, w())[a] = (new Date).getTime(), G(a, "_p", c))
  }, J = function(a) {
    return a.join("__").
        replace(/\./g, "_").
        replace(/\-/g, "_").
  ...
  M.push([
    ...
    function(a) {
      ...
      if (b = a.u) a = u(A, "us", []), a.push(b), (b = /^https:(.*)$/.exec(
          b)) && a.push("http:" + b[1])
    }]);
  var da = /^(\/[a-zA-Z0-9_\-]+)+$/, O = [/\/amp\//, /\/amp$/, /^\/amp$/],
      ea = /^[a-zA-Z0-9\-_\.,!]+$/, fa = /^gapi\.loaded_[0-9]+$/,
      ha = /^[a-zA-Z0-9,._-]+$/, la = function(a, b, c, d) {
        ...
        var e =
            function(a) {return encodeURIComponent(a).replace(/%2C/g, ",")};
        return [
          encodeURIComponent(a.pathPrefix).
              replace(/%2C/g, ",").
              replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b),
          d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1",
          a.a ? "/am=" + e(a.a) : "", a.c ? "/rs=" + e(a.c) : "",
          a.f ? "/t=" + e(a.f) : "", "/cb=", e(c)].join("")
      }, ma = function(a) {
        "/" !== a.charAt(0) && N("relative path");
        for (var b = a.substring(1).split("/"), c = []; b.length;) {
          a = b.shift();
          if (!a.length || 0 == a.indexOf(".")) N(
              "empty/relative directory"); else if (0 < a.indexOf("=")) {
            b.unshift(a);
            break
          }
          c.push(a)
        ...
        for (var d = 0, e = b.length; d < e; ++d) {
          var f = b[d].split("="), l = decodeURIComponent(f[0]),
  ...
  var R = decodeURI("%73cript"), S = /^[-+_0-9\/A-Za-z]+={0,2}$/,
      T = function(a, b) {
        ...
        var a = A.nonce;
        if (void 0 !== a) return a && a === String(a) && a.match(S)
            ? a
            : A.nonce = null;
        var b = u(A, "us", []);
        ...
        for (var c = h.getElementsByTagName(R), d = 0, e = c.length; d < e; ++d) {
          ...
          if (f.src &&
            ...
            for (var l =
                0, k = b.length; l < k && b[l] !== f.src; ++l) ;
            if (l !== k && a && a === String(a) && a.match(S)) return A.nonce = a
          }
        }
        return null
      }, pa = function(a) {
      ...
      b) {
        ...
        if (e["::"] && b.length) {
          ...
          for (var f = null; f = b.shift();) {
            ...
            var k = a.length && a[a.length - 1] || null, v =
                k;
        ...
        a = aa(a) || [];
        var d = b.callback, e = b.config, f = b.timeout, l = b.ontimeout,
            k = b.onerror, v = void 0;
        "function" == typeof k && (v = k);
        var y = null, z = !1;
        if (f && !l || !f &&
            l) throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";
        k = u(C(c), "r", []).sort();
        var H = u(C(c), "L", []).sort(), E = [].concat(k),
            W = function(a, b) {
              if (z) return 0;
              g.clearTimeout(y);
              H.push.apply(H, p);
              ...
              if (b) {
                K("me0", a, E);
                try {ra(b, c, v)} finally {K("me1", a, E)}
              }
              return 1
            };
  ...
  var X = function(a, b) {
    if (A.hee && 0 < A.hel) try {return a()} catch (c) {
      b && b(c), A.hel--, Z("debug_error",
...
gapi.load("client", {
  ...
  _c: {
    "jsl": {
      ...
      "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.rH_DNAowp7o.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPjBnH1F4aCnBCh3-1YeKgkbV6kbg",
      "u": "https://apis.google.com/js/client.js",
      "hee": true,
      "fp": "283fd1cc934169a06078f4520c79baac1423787a",
      "dpo": false
    },
    "fp": "283fd1cc934169a06078f4520c79baac1423787a",
    "annotation": [
